...
namespace EMWebApi.Controllers
{
    public class ClientesController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetCliente(decimal id)
        {
        ...
        public async Task<IHttpActionResult> PutCliente(decimal id, Cliente cliente)
        {
        ...
        [ResponseType(typeof(Cliente))]
        public async Task<IHttpActionResult> DeleteCliente(decimal id)
        {
            Cliente cliente = await db.Clientes.FindAsync(id);
            if (cliente == null)
            {
